/*! gradient animation*/
{
    ...
    DOM.galleryButtons = Array.from(document.querySelectorAll('.gallery-button'))
    
    DOM.galleryButtons.forEach((galleryButton) => {
        galleryButton.addEventListener('click', (ev) => {
            ev.preventDefault();
            close();
            setTimeout(() => {
                open(3)
    ...
    DOM.contactButtons = Array.from(document.querySelectorAll('.contact-button'))
    
    DOM.contactButtons.forEach((contactButton) => {
        contactButton.addEventListener('click', (ev) => {
            ev.preventDefault();
            close();
            setTimeout(() => {
                open(4)
